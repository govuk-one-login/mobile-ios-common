...
struct MockLinkTheAppViewModel: LinkTheAppViewModel {
    ...
    init() {
        let viewModel1 = MockOptionViewModel()
        let view1 = OptionView(viewModel: viewModel1)
        let viewModel2 = MockOptionViewModel()
        let view2 = OptionView(viewModel: viewModel2)
