...
We recommend using the Analytics package alongside our [Logging package](https://github.com/orgs/govuk-one-login/mobile-ios-logging) to submit the events to Firebase Analytics.
