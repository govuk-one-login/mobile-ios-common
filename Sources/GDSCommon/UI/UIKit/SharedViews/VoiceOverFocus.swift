...
/// For screen view controllers within `GDSCommon` that have a ``titleLabel`` property and inherti from ``BaseViewController``, conform the view controller to ``TitledViewController`` to
